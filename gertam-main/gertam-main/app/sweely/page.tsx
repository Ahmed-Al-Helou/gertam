...
const handleSubmit = async (e: any) => {
  ...
  try {
    ...
    const res = await fetch(`${process.env.NEXT_PUBLIC_SERVER_APP_BASE_URL}/merchant`, {
      method: "POST",
      headers: {
    ...
    if (res.ok) {
      ...
      alert(json.message || "خطأ في الإرسال");
    }
  } catch (err) {
      ...
      <div className="max-w-4xl w-full bg-white/95 backdrop-blur-sm p-8 md:p-12 rounded-3xl shadow-2xl border border-white/20 relative overflow-hidden">
        ...
        <div className="relative z-10">
          <h1 className="text-3xl md:text-4xl font-bold bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent mb-2 text-center">
            نموذج تسجيل التاجر في منصة Gertam
          </h1>
          <p className="text-gray-500 text-center mb-8">املأ النموذج أدناه لإتمام عملية التسجيل</p>
            ...
            >
              ...
              >
                ...
                <div className="relative z-10">
                  ...
                  >
                    شكرًا لك! سيتم مراجعة بياناتك قريبًا.
                  </motion.p>
